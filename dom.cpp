...
uint16_t node_intf::node_type() const
{
	return type_;
}
...
node node_intf::first_child() const
{
	return node(first_child_);
}

node node_intf::last_child() const
{
	return node(last_child_);
}

node node_intf::previous_sibling() const
{
	return node(previous_sibling_);
}

node node_intf::next_sibling() const
{
